...
public class System {
	 ...
	 */
	public void removeRecorrido(Recorrido route) {
	}
	 ...
	 */
	public List<Billete> getAssociatedBilletesToRoute(Recorrido route) {
		return null;
	}
	 ...
	 */
	public void updateRecorridoDate(Recorrido route, LocalDate newDate) {
	}
	 ...
	 */
	public void updateRecorridoTime(Recorrido route, LocalTime newTime) {
	}
	 ...
	 */
	public void updateRecorridoDateTime(Recorrido route, LocalDateTime newDateTime) {
	}
	 ...
	 * @throws IllegalStateException if the new Date time is the already the set
	 */
	public void updateRecorrido(Recorrido route, LocalDate newDate, LocalTime newTime) {
	}
